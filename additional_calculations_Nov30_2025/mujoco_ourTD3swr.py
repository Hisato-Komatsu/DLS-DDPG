...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_ourTD3swr" + name_condition + ".txt"
   file_learning_curve = open(filename_learning_curve, "w")
   
   filename_learning_curve_eval = "LC_eval_ourTD3swr" + name_condition + ".txt"
   ...
   if hyper.movie_record:
      ...
      name_prefix = "movie_ourTD3swr" + name_condition
