...
if __name__ == '__main__':
   ...
   filename_learning_curve = "LC_LScDDPG_softT_offC" + name_condition + ".txt"
   file_learning_curve = open(filename_learning_curve, "w")
   
   filename_learning_curve_eval = "LC_eval_LScDDPG_softT_offC" + name_condition + ".txt"
   file_learning_curve_eval = open(filename_learning_curve_eval, "w")
   
   weight_record = hyper.weight_record
   if weight_record:
      filename_weight = "weight_LScDDPG_softT_offC" + name_condition + ".txt"
   ...
   if hyper.time_record:
      filename_time = "time_LScDDPG_softT_offC" + name_condition + ".txt"
